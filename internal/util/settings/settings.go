...
type AppSettings struct {
	...
	ProviderPrivKey    string `mapstructure:"PROVIDER_PRIVATE_KEY"` // Provider private key
	ProviderKeyVersion uint32 `mapstructure:"PROVIDER_KEY_VERSION"` // Key version of provider private key
